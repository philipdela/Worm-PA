    ...
    if ((ch = getch()) > 0) {
        ...
        switch(ch) {
            ...
            case ' ' : // Terminate single step; make getch non-blocking again
                ...
                break;
           case 'z':  //User wants upright
                setWormHeading(WORM_OR);
               break;
           case 't':  //User wants upleft
               setWormHeading(WORM_OL);
               break;
           case 'h':  //User wants  downright
               setWormHeading(WORM_UR);
               break;
           case 'g':  //User wants  downleft
               setWormHeading(WORM_UL);
               break;
...
void setWormHeading(enum WormHeading dir) {
    switch(dir) {
        ...
        case WORM_RIGHT :// User wants right
            ...
            theworm_dy=0;
            break;
        case WORM_OR :// User wants upright
            theworm_dx=1;
            theworm_dy=-1;
            break;
       case WORM_OL :// User wants upleft
            theworm_dx=-1;
            theworm_dy=-1;
            break;
       case WORM_UR :// User wants downright
            theworm_dx=1;
            theworm_dy=1;
            break;
      case WORM_UL :// User wants downleft
            theworm_dx=-1;
            theworm_dy=1;
            break;
    }
