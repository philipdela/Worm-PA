...
enum ResCodes initializeWorm(int max_len, int headpos_y, int headpos_x, enum WormHeading dir, enum ColorPairs color);
void showWorm();
void cleanWormTail();
  ...
  if ((ch = getch()) > 0) {
    ...
    switch(ch) {
      ...
      case KEY_RIGHT :// User wants right
        ...
        break;
        // case 'a': //User wants up_left
        // setWormHeading(WORM_UP_LEFT);
        // break;

        // case 'w': // User wants up_right
        // setWormHeading(WORM_UP_RIGHT);
        // break;

        // case 'y': // User wants down_left
        // setWormHeading(WORM_DOWN_LEFT);
        // break;

        // case 'd': // User wants down_right
